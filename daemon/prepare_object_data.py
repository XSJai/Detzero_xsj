...
class WaymoObjectDataPrepare():
    ...
    def prepare_data_worker(self, seq_dict):
        ...
        for frm_id in frame_ids:
            ...
            if len(frm_info['boxes_global']) > 0:
                ...
                lidar_path = os.path.join(self.root_path,
                    'waymo_processed_data/segment-%s_with_camera_labels/%s.npy' % (seq, frm_id))
        ...
        print(f"daemon prepare object file has been saved ==> {save_path}")
...
if __name__ == '__main__':
    ...
    parser.add_argument('--track_data_path', type=str, default="/home/xsj/data/DetZero-main/data/waymo/tracking/tracking-train-20250102-144531.pkl",
