...
if __name__ == '__main__':
    ...
    parser.add_argument('--combine_conf_res', action='store_true', default=True,
                        help='combine the confidence refining results together')
    parser.add_argument('--combine_drop_path', type=str, default="/home/xsj/data/DetZero-main/data/waymo/tracking/drop-train-20250102-144531.pkl",
