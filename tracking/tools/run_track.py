...
def parse_config():
    ...
    parser.add_argument('--cfg_file', type=str, default="/home/xsj/data/DetZero-main/tracking/tools/cfgs/tk_model_cfgs/waymo_detzero_track.yaml", help='load the config for tracking')
    parser.add_argument('--data_path', type=str, default='/home/xsj/data/DetZero-main/detection/output/home/xsj/data/DetZero-main/detection/tools/cfgs/det_model_cfgs/centerpoint_5sweeps/default/eval/epoch_5/val/result.pkl', help='data path of detection results')
    parser.add_argument('--workers', type=int, default=1, help='num of cpu for running track module')
    parser.add_argument('--batch_size', type=int, default=1, help='batch size for dataloader')
    parser.add_argument('--split', type=str, default='train', help='different data split')
    parser.add_argument('--save_log', action="store_true", default=True, help="save log info into .txt")
