...
def parse_config():
    ...
    parser.add_argument('--cfg_file', type=str, default="/home/xsj/data/DetZero-main/detection/tools/cfgs/det_model_cfgs/centerpoint_5sweeps.yaml", help='specify the config for training')
    ...
    parser.add_argument('--ckpt', type=str, default="/home/xsj/data/DetZero-main/detection/output/det_model_cfgs/centerpoint_5sweeps/default/ckpt/checkpoint_epoch_5.pth", help='checkpoint to start from')
