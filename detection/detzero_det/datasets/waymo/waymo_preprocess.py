...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg_file', type=str, default="/home/xsj/data/DetZero-main/detection/tools/cfgs/det_dataset_cfgs/waymo_1sweep.yaml", help='specify the config of dataset')
