...
def parse_config():
    ...
    parser.add_argument('--cfg_file', type=str, default="/home/xsj/data/DetZero-main/refining/tools/cfgs/ref_model_cfgs/vehicle_grm_model.yaml", help='specify the config for training')
...
def main():
    ...
    test_set, test_loader, sampler = build_dataloader(
        ...
        class_names=cfg.CLASS_NAMES,
        batch_size=args.batch_size,
        dist=dist_train, workers=args.workers, logger=logger, training=True  # xsj修改
    )
